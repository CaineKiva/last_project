...
class PatientRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'contact_phone' => 'required|numeric|regex:[0[0-9]{9}$]',
    ...
    public function messages()
    {
        return [
            ...
            'contact_phone' => 'Vui lòng điền :attribute',
            'contact_phone.numeric' => ':attribute phải được điền bằng số',
            'contact_phone.regex' => ':attribute phải có 10 chữ số, bắt đầu từ số 0',
