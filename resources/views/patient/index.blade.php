...
<div id="form_insert" style="display: none ;">
		...
		<div class="card-body card-block" >
			<form action="{{ route('patient.process_insert') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
				@csrf
				<div class="row form-group">
				...
				<div class="row form-group">
					...
					<div class="col-12 col-md-9"><input type="text" id="text-input" name="contact_phone" placeholder="Nhập SĐT" class="form-control" value="{{ old('contact_phone') }}">{{ $errors->first('contact_phone') }}</div>
				</div>
				<div class="row form-group">
