        ...
        @endif 
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
             <div class="appointment-form">
                <h3 style="text-align: center;"><span>+</span><a data-scroll onclick="show_appointment()" class="appointment_data" patient_id = "{{ Session::get('patient_id') }}" style="color: white"> Xem lịch hẹn khám</h3>
                <div class="form">
