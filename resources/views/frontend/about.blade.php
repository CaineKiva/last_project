<div id="about" class="section wow fadeIn">
    <div class="container">
       <div class="heading">
          <span class="icon-logo"><img src="{{ asset('public/images/icon-logo.png') }}" alt="#"></span>
       ...
       <div class="row">
          ...
          <div class="col-md-6">
             <div class="post-media wow fadeIn">
                <img src="{{ asset('public/images/about_03.jpg') }}" alt="" class="img-responsive">
       ...
       <div class="row">
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
             <div class="service-widget">
                <div class="post-media wow fadeIn">
                   <a href="{{ asset('public/images/clinic_02.jpg') }}" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                   <img src="{{ asset('public/images/clinic_02.jpg') }}" alt="" class="img-responsive">
                </div>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
             <div class="service-widget">
                <div class="post-media wow fadeIn">
                   <a href="{{ asset('public/images/clinic_03.jpg') }}" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                   <img src="{{ asset('public/images/clinic_03.jpg') }}" alt="" class="img-responsive">
                </div>
